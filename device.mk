...
$(call inherit-product, device/lcsh/QK1503_M02/vendor/copyfiles.mk)
$(call inherit-product, vendor/lcsh/QK1503_M02/QK1503_M02-vendor-blobs.mk)
...
TARGET_OTA_ASSERT_DEVICE := QK1503_M02
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ramdisk/fstab.mt6797:root/fstab.mt6797 \
    $(LOCAL_PATH)/ramdisk/init.aee.rc:root/init.aee.rc \
    $(LOCAL_PATH)/ramdisk/init.modem.rc:root/init.modem.rc \
    $(LOCAL_PATH)/ramdisk/init.mt6797.rc:root/init.mt6797.rc \
    $(LOCAL_PATH)/ramdisk/init.mt6797.usb.rc:root/init.mt6797.usb.rc \
...
PRODUCT_COPY_FILES += \
     ...
     $(LOCAL_PATH)/configs/.thermal_policy_01:system/etc/.tp/.thermal_policy_01 \
	  ...
	  $(LOCAL_PATH)/configs/.thermal_policy_03:system/etc/.tp/.thermal_policy_03 \
	  $(LOCAL_PATH)/configs/highcore_thermal.conf:system/etc/.tp/highcore_thermal.conf \
	  $(LOCAL_PATH)/configs/thermal-screenoff-full.conf:system/etc/.tp/thermal-screenoff-full.conf

    
# These are the hardware-specific features
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml \
